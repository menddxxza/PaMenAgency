...
export default function ComparadorFavoritos({
  ...
  // El aviso de "hay más tabla a la derecha" solo tiene sentido si de verdad
  // se sale del ancho visible — si no, engañaría sugiriendo columnas que no existen.
  useEffect(() => {
    const el = scrollRef.current;
    if (!el) return;
    const comprobar = () => setDesborda(el.scrollWidth > el.clientWidth + 1);
    comprobar();
