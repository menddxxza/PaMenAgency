# Graph Report - PaMenAgency  (2026-09-14)

## Corpus Check
- 196 files · ~80,838 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 10 file(s) not represented in the graph (top: (none) 4, .example 3, .css 2)
